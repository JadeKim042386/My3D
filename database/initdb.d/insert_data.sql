...
-- 게시글 10개
insert into article (user_account_id, title, summary, content, created_by, modified_by, created_at, modified_at, article_type, article_category, like_count, price_id) values
