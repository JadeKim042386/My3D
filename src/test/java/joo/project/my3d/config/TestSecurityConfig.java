...
//                .willReturn(FixtureDto.getUserAccountDto("jooAdmin", UserRole.ADMIN));
        ...
        given(tokenProvider.getUserDetails(eq(companyClaims))).willReturn(FixtureDto.getPrincipal("jooCompany", UserRole.COMPANY));
        ...
        given(tokenProvider.getUserDetails(eq(userClaims))).willReturn(FixtureDto.getPrincipal("jooUser", UserRole.USER));
        ...
        given(tokenProvider.getUserDetails(eq(anonymousClaims))).willReturn(FixtureDto.getPrincipal("anonymous", UserRole.ANONYMOUS));
    }
