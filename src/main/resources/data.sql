-- 테스트 계정 3개
insert into user_account (email, user_password, nickname, phone, city, street, zipcode, user_role, created_at, created_by, modified_at, modified_by) values
('jk042386@gmail.com', '{noop}1234asdf', 'Joo', '01012341234', null, null, null, 'ADMIN', now(), 'joo', now(), 'joo'),
('a@gmail.com', '{noop}1234asdf', 'A', '01011111111', null, null, null, 'USER', now(), 'a', now(), 'a'),
('jujoo042386@gmail.com', '{noop}1234asdf', 'Jujoo', '01022222222', null, null, null, 'COMPANY', now(), 'jujoo', now(), 'jujoo');
