...
public record ArticleCommentDto(
    ...
    public static ArticleCommentDto of(
            ...
            String email,
            Long parentCommentId) {
        Comparator<ArticleCommentDto> childCommentComparator =
                Comparator.comparing(ArticleCommentDto::createdAt).thenComparingLong(ArticleCommentDto::id);
     ...
     */
    public static ArticleCommentDto of(
            Long articleId, String content, String nickname, String email, Long parentCommentId) {
